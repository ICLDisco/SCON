...
#ifndef SCON_POINTER_ARRAY_H
#define SCON_POINTER_ARRAY_H
 ...
 * Convenience typedef
 */
typedef struct scon_pointer_array_t scon_pointer_array_t;
/**
 * Class declaration
 */
SCON_CLASS_DECLARATION(scon_pointer_array_t);
 ...
 *
 * @return SCON_SUCCESS if all initializations were succesfull. Otherwise,
 ...
 */
int scon_pointer_array_add(scon_pointer_array_t *array, void *ptr);
 ...
 *
 * @return SCON_SUCCESS if item was inserted. Otherwise,
 *  the error indicate what went wrong in the function.
 */
scon_status_t scon_pointer_array_set_item(scon_pointer_array_t *array,
...
static inline void *scon_pointer_array_get_item(scon_pointer_array_t *table,
                                                int element_index)
{
    void *p;
 ...
 */
static inline int scon_pointer_array_get_size(scon_pointer_array_t *array)
{
  return array->size;
}
 ...
 *
 * @return SCON_SUCCESS new size was set. Otherwise,
 *  the error indicate what went wrong in the function.
 *
 * Simple function to set the size of the array in order to
 * hide the member field from external users.
 */
scon_status_t scon_pointer_array_set_size(scon_pointer_array_t *array, int size);
 ...
 *
 */
static inline void scon_pointer_array_remove_all(scon_pointer_array_t *array)
{
    int i;
