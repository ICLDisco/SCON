 ...
 * @file
 *
 * Implementation of scon_object_t, the base scon foundation class
 */
 ...
 */
scon_class_t scon_object_t_class = {
    "scon_object_t",      /* name */
    NULL,                 /* parent class */
    NULL,                 /* constructor */
    NULL,                 /* destructor */
    ...
    sizeof(scon_object_t) /* size of the scon object */
};
 ...
 * Local functions
 */
static void save_class(scon_class_t *cls);
 ...
 */
void scon_class_initialize(scon_class_t *cls)
{
    scon_class_t *c;
    ...
    cls->cls_construct_array =
        (void (**)(scon_object_t*))malloc((cls_construct_array_count +
                                           cls_destruct_array_count + 2) *
                                          sizeof(scon_construct_t) );
