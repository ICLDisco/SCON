/* src/include/scon_config.h.  Generated from scon_config.h.in by configure.  */
/* src/include/scon_config.h.in.  Generated from configure.ac by autoheader.  */
...
#define SCON_CONFIG_H

#include <src/include/scon_config_top.h>
...
#define SCON_ALIGNMENT_CHAR 1

/* Alignment of type double */
#define SCON_ALIGNMENT_DOUBLE 8

/* Alignment of type float */
#define SCON_ALIGNMENT_FLOAT 4

/* Alignment of type int */
#define SCON_ALIGNMENT_INT 4

/* Alignment of type int16_t */
#define SCON_ALIGNMENT_INT16 2

/* Alignment of type int32_t */
#define SCON_ALIGNMENT_INT32 4

/* Alignment of type int64_t */
#define SCON_ALIGNMENT_INT64 8

/* Alignment of type int8_t */
#define SCON_ALIGNMENT_INT8 1

/* Alignment of type long */
#define SCON_ALIGNMENT_LONG 8

/* Alignment of type long double */
/* #undef SCON_ALIGNMENT_LONG_DOUBLE */

/* Alignment of type long long */
#define SCON_ALIGNMENT_LONG_LONG 8

/* Alignment of type short */
#define SCON_ALIGNMENT_SHORT 2

/* Alignment of type size_t */
#define SCON_ALIGNMENT_SIZE_T 8

/* Alignment of type void * */
#define SCON_ALIGNMENT_VOID_P 8

/* Alignment of type wchar_t */
#define SCON_ALIGNMENT_WCHAR 4

/* The compiler $lower which SCON was built with */
#define SCON_BUILD_PLATFORM_COMPILER_FAMILYID 0

/* The compiler $lower which SCON was built with */
#define SCON_BUILD_PLATFORM_COMPILER_FAMILYNAME UNKNOWN

/* The compiler $lower which SCON was built with */
#define SCON_BUILD_PLATFORM_COMPILER_VERSION 0

/* The compiler $lower which SCON was built with */
#define SCON_BUILD_PLATFORM_COMPILER_VERSION_STR UNKNOWN

/* SCON underlying C compiler */
#define SCON_CC "gcc"

/* Use static const char[] strings for C files */
#define SCON_CC_USE_CONST_CHAR_IDENT 1

/* Use #ident strings for C files */
#define SCON_CC_USE_IDENT 0

/* Use #pragma comment for C files */
#define SCON_CC_USE_PRAGMA_COMMENT 

/* Use #pragma ident strings for C files */
#define SCON_CC_USE_PRAGMA_IDENT 0

/* Whether C compiler supports __builtin_clz */
#define SCON_C_HAVE_BUILTIN_CLZ 1

/* Whether C compiler supports __builtin_expect */
#define SCON_C_HAVE_BUILTIN_EXPECT 1

/* Whether C compiler supports __builtin_prefetch */
#define SCON_C_HAVE_BUILTIN_PREFETCH 1

/* Whether C compiler supports symbol visibility or not */
#define SCON_C_HAVE_VISIBILITY 1

/* Whether we are in debugging mode or not */
#define SCON_ENABLE_DEBUG 1

/* if want special dstore feature */
#define SCON_ENABLE_DSTORE 0

/* Whether we want developer-level timing support or not */
#define SCON_ENABLE_TIMING 0

/* Location of event2/thread.h */
#define SCON_EVENT2_THREAD_HEADER <event2/thread.h>

/* Location of event.h */
#define SCON_EVENT_HEADER <event.h>

/* Whether your compiler has __attribute__ or not */
#define SCON_HAVE_ATTRIBUTE 1

/* Whether your compiler has __attribute__ aligned or not */
#define SCON_HAVE_ATTRIBUTE_ALIGNED 1

/* Whether your compiler has __attribute__ always_inline or not */
#define SCON_HAVE_ATTRIBUTE_ALWAYS_INLINE 1

/* Whether your compiler has __attribute__ cold or not */
#define SCON_HAVE_ATTRIBUTE_COLD 1

/* Whether your compiler has __attribute__ const or not */
#define SCON_HAVE_ATTRIBUTE_CONST 1

/* Whether your compiler has __attribute__ deprecated or not */
#define SCON_HAVE_ATTRIBUTE_DEPRECATED 1

/* Whether your compiler has __attribute__ deprecated with optional argument
   */
#define SCON_HAVE_ATTRIBUTE_DEPRECATED_ARGUMENT 1

/* Whether your compiler has __attribute__ destructor or not */
#define SCON_HAVE_ATTRIBUTE_DESTRUCTOR 1

/* Whether your compiler has __attribute__ format or not */
#define SCON_HAVE_ATTRIBUTE_FORMAT 1

/* Whether your compiler has __attribute__ format and it works on function
   pointers */
#define SCON_HAVE_ATTRIBUTE_FORMAT_FUNCPTR 1

/* Whether your compiler has __attribute__ hot or not */
#define SCON_HAVE_ATTRIBUTE_HOT 1

/* Whether your compiler has __attribute__ malloc or not */
#define SCON_HAVE_ATTRIBUTE_MALLOC 1

/* Whether your compiler has __attribute__ may_alias or not */
#define SCON_HAVE_ATTRIBUTE_MAY_ALIAS 1

/* Whether your compiler has __attribute__ nonnull or not */
#define SCON_HAVE_ATTRIBUTE_NONNULL 1

/* Whether your compiler has __attribute__ noreturn or not */
#define SCON_HAVE_ATTRIBUTE_NORETURN 1

/* Whether your compiler has __attribute__ noreturn and it works on function
   pointers */
#define SCON_HAVE_ATTRIBUTE_NORETURN_FUNCPTR 1

/* Whether your compiler has __attribute__ no_instrument_function or not */
#define SCON_HAVE_ATTRIBUTE_NO_INSTRUMENT_FUNCTION 1

/* Whether your compiler has __attribute__ packed or not */
#define SCON_HAVE_ATTRIBUTE_PACKED 1

/* Whether your compiler has __attribute__ pure or not */
#define SCON_HAVE_ATTRIBUTE_PURE 1

/* Whether your compiler has __attribute__ sentinel or not */
#define SCON_HAVE_ATTRIBUTE_SENTINEL 1

/* Whether your compiler has __attribute__ unused or not */
#define SCON_HAVE_ATTRIBUTE_UNUSED 1

/* Whether your compiler has __attribute__ visibility or not */
#define SCON_HAVE_ATTRIBUTE_VISIBILITY 1

/* Whether your compiler has __attribute__ warn unused result or not */
#define SCON_HAVE_ATTRIBUTE_WARN_UNUSED_RESULT 1

/* Whether your compiler has __attribute__ weak alias or not */
#define SCON_HAVE_ATTRIBUTE_WEAK_ALIAS 

/* whether qsort is broken or not */
#define SCON_HAVE_BROKEN_QSORT 0

/* whether ceil is found and available */
#define SCON_HAVE_CEIL 1
...
#define SCON_SYMBOL_RENAME "src/include/rename.h"
...
#define SCON_WANT_PRETTY_PRINT_STACKTRACE 1
...
#include <src/include/scon_config_bottom.h>
#endif /* SCON_CONFIG_H */
