...
#ifndef SCON_BASENAME_H
#define SCON_BASENAME_H
 ...
 */
char *scon_basename(const char* filename) __scon_attribute_malloc__ __scon_attribute_warn_unused_result__;
 ...
 * The caller is responsible for freeing the returned string.
 */
char *scon_dirname(const char* filename) __scon_attribute_malloc__ __scon_attribute_warn_unused_result__;

END_C_DECLS

#endif /* SCON_BASENAME_H */
