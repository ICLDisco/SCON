 ...
 */
char *scon_path_find(char *fname, char **pathv, int mode,
                                   char **envv) __scon_attribute_malloc__ __scon_attribute_warn_unused_result__;
 ...
 * The caller is responsible for freeing the returned string.
 */
char *scon_path_findv(char *fname, int mode,
                                    char **envv, char *wrkdir) __scon_attribute_malloc__ __scon_attribute_warn_unused_result__;
/**
 ...
 * will be returned.
 */
char* scon_find_absolute_path( char* app_name ) __scon_attribute_warn_unused_result__;
 ...
 * The caller is responsible for freeing the returned string.
 */
char *scon_path_access(char *fname, char *path, int mode) __scon_attribute_malloc__ __scon_attribute_warn_unused_result__;
 ...
 * @retval false               otherwise
 */
bool scon_path_nfs(char *fname, char **fstype) __scon_attribute_warn_unused_result__;
 ...
 *
 * @retval SCON_SUCCESS  If the operation was successful
 * @retval SCON_ERROR    otherwise
 */
int
scon_path_df(const char *path,
             uint64_t *out_avail)__scon_attribute_warn_unused_result__;
