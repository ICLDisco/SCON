...
BEGIN_C_DECLS
   ...
   */
scon_status_t scon_argv_append(int *argc, char ***argv, const char *arg) __scon_attribute_nonnull__(1) __scon_attribute_nonnull__(3);
   ...
   * @retval SCON_ERROR On failure
   *
   * This function is identical to the scon_argv_append() function
 ...
 * @retval SCON_ERROR On failure
 */
scon_status_t scon_argv_prepend_nosize(char ***argv, const char *arg);
 ...
 * @retval SCON_ERROR On failure
 *
 * This function is identical to the scon_argv_append_nosize() function
 ...
 */
scon_status_t scon_argv_append_unique_nosize(char ***argv, const char *arg, bool overwrite);
...
void scon_argv_free(char **argv);
   ...
   */
char **scon_argv_split(const char *src_string, int delimiter) __scon_attribute_malloc__ __scon_attribute_warn_unused_result__;
   ...
   * without invalidating the output argv).
   */
char **scon_argv_split_with_empty(const char *src_string, int delimiter) __scon_attribute_malloc__ __scon_attribute_warn_unused_result__;
...
int scon_argv_count(char **argv);
   ...
   */
char *scon_argv_join(char **argv, int delimiter) __scon_attribute_malloc__ __scon_attribute_warn_unused_result__;

char *scon_argv_join_range(char **argv, size_t start, size_t end, int delimiter) __scon_attribute_malloc__ __scon_attribute_warn_unused_result__;
   ...
   */
size_t scon_argv_len(char **argv);
   ...
   */
char **scon_argv_copy(char **argv) __scon_attribute_malloc__ __scon_attribute_warn_unused_result__;
     ...
     */
scon_status_t scon_argv_delete(int *argc, char ***argv,
     ...
     * @retval SCON_BAD_PARAM if any parameters are non-sensical
     *
     ...
     * Similar to scon_argv_append(), the target may be realloc()'ed
     ...
     * target).
     */
scon_status_t scon_argv_insert(char ***target, int start, char **source);
 ...
 * target).
 */
scon_status_t scon_argv_insert_element(char ***target, int location, char *source);
