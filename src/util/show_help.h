 ...
 * @file
 *
 * The "show help" subsystem (SHS) in SCON is intended to help the
 ...
 *
 * The function scon_show_help() is used to find a help message and
 ...
 * for that file in $pkgdatadir (typically $prefix/share/scon).
 *
 ...
 * scon_show_help() takes a variable legnth argument list that are
 ...
 * component may install its own helpfile in SCON's $pkgdatadir,
 * and therefore the component can invoke scon_show_help() to display
...
#ifndef SCON_SHOW_HELP_H
#define SCON_SHOW_HELP_H
 ...
 * (typically $prefix/share/scon), and looks up the message
 ...
 */
char* scon_show_help_string(const char *filename,
                                          const char *topic,
                                          bool want_error_header, ...);

/**
 * This function does the same thing as scon_show_help_string(), but
 * accepts a va_list form of varargs.
 */
char* scon_show_help_vstring(const char *filename,
                                          const char *topic,
                                          bool want_error_header, va_list ap);
