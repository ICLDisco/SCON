 ...
 *
 * The scon_os_path() function takes a variable number of string arguments and
...
#ifndef SCON_OS_PATH_H
#define SCON_OS_PATH_H
...
*/
char *scon_os_path(bool relative, ...) __scon_attribute_malloc__ __scon_attribute_sentinel__ __scon_attribute_warn_unused_result__;

/**
 * Convert the path to be OS friendly. On UNIX this function will
 * be empty.
 */
#define scon_make_filename_os_friendly(PATH)   (PATH)

END_C_DECLS

#endif /* SCON_OS_PATH_H */
