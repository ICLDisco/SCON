...
#ifndef SCON_PRINTF_H
#define SCON_PRINTF_H
 ...
 */
int  scon_snprintf(char *str, size_t size, const char *fmt, ...) __scon_attribute_format__(__printf__, 3, 4);
 ...
 */
int  scon_vsnprintf(char *str, size_t size, const char *fmt, va_list ap) __scon_attribute_format__(__printf__, 3, 0);
 ...
 */
int  scon_asprintf(char **ptr, const char *fmt, ...) __scon_attribute_format__(__printf__, 2, 3);
 ...
 */
int  scon_vasprintf(char **ptr, const char *fmt, va_list ap) __scon_attribute_format__(__printf__, 2, 0);
