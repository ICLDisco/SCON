...
#if !defined(SCON_MCA_BASE_VAR_ENUM_H)
#define SCON_MCA_BASE_VAR_ENUM_H
...
typedef struct scon_mca_base_var_enum_t scon_mca_base_var_enum_t;
 ...
 */
typedef int (*scon_mca_base_var_enum_get_count_fn_t)(scon_mca_base_var_enum_t *self, int *count);
 ...
 */
typedef int (*scon_mca_base_var_enum_get_value_fn_t)(scon_mca_base_var_enum_t *self, int index,
 ...
 *
 * @retval SCON_SUCCESS if found
 * @retval SCON_ERR_VALUE_OUT_OF_BOUNDS if not
 */
typedef int (*scon_mca_base_var_enum_vfs_fn_t)(scon_mca_base_var_enum_t *self, const char *string_value,
                                               int *value);
 ...
 * @retval scon error on error
 */
typedef int (*scon_mca_base_var_enum_dump_fn_t)(scon_mca_base_var_enum_t *self, char **out);
 ...
 *
 * @retval SCON_SUCCESS on success
 * @retval SCON_ERR_VALUE_OUT_OF_BOUNDS if not found
 *
 ...
 */
typedef int (*scon_mca_base_var_enum_sfv_fn_t)(scon_mca_base_var_enum_t *self, const int value,
                                               char **string_value);
 ...
 */
struct scon_mca_base_var_enum_value_t {
    int value;
    const char *string;
};

typedef struct scon_mca_base_var_enum_value_t scon_mca_base_var_enum_value_t;

/**
 * enumerator base class
 */
struct scon_mca_base_var_enum_t {
    scon_object_t super;
    ...
    scon_mca_base_var_enum_value_t *enum_values;
};
 ...
 */
struct scon_mca_base_var_enum_value_flag_t {
...
typedef struct scon_mca_base_var_enum_value_flag_t scon_mca_base_var_enum_value_flag_t;

/**
 * flag enumerator base class
 */
struct scon_mca_base_var_enum_flag_t {
    /** use the existing enumerator interface */
    scon_mca_base_var_enum_t super;
    /** flag value(s) */
    scon_mca_base_var_enum_value_flag_t *enum_flags;
};

typedef struct scon_mca_base_var_enum_flag_t scon_mca_base_var_enum_flag_t;

/**
 * Object declaration for scon_mca_base_var_enum_t
 */
SCON_CLASS_DECLARATION(scon_mca_base_var_enum_t);
 ...
 *
 * @retval SCON_SUCCESS On success
 * @retval scon error code On error
 *
 ...
 * strings passed in values[] after scon_mca_base_var_enum_create()
 * returns.
 */
int scon_mca_base_var_enum_create (const char *name, const scon_mca_base_var_enum_value_t values[],
                                   scon_mca_base_var_enum_t **enumerator);
 ...
 * returns.
 */
int scon_mca_base_var_enum_create_flag (const char *name, const scon_mca_base_var_enum_value_flag_t flags[],
                                        scon_mca_base_var_enum_flag_t **enumerator);
 ...
 */
extern scon_mca_base_var_enum_t scon_mca_base_var_enum_bool;

/**
 * Verbosity level enumerator
 */
extern scon_mca_base_var_enum_t scon_mca_base_var_enum_verbose;
