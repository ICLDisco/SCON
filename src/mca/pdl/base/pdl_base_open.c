 ...
 * Globals
 */
scon_pdl_base_module_t *scon_pdl = NULL;
scon_pdl_base_component_t *scon_pdl_base_selected_component = NULL;
...
int scon_pdl_base_open(scon_mca_base_open_flag_t flags)
{
    ...
    return scon_mca_base_framework_components_open(&scon_pdl_base_framework, flags);
}
...
/* VERY IMPORTANT: This framework is static, and is opened before any
   ...
   framework. */
SCON_MCA_BASE_FRAMEWORK_DECLARE(scon, pdl, "Dynamic loader framework",
                                NULL /* register */,
                                scon_pdl_base_open /* open */,
                                NULL /* close */,
