...
int scon_common_base_select(void)
{
    ...
    scon_common_base_component_t *best_component = NULL;
    scon_common_module_t *best_module = NULL;

    /*
     * Select the best component
     */
    if (SCON_SUCCESS != scon_mca_base_select("common",
            scon_common_base_framework.framework_output,
            &scon_common_base_framework.framework_components,
    ...
    /* Save the winner */
    scon_common_base_selected_component = best_component;
    scon_common = *best_module;
