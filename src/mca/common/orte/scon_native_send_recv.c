 ...
 */
static void orte_scon_native_send_complete (int status,
...
static void orte_scon_native_process_send (int fd, short flags, void *cbdata)
{
    orte_scon_send_req_t *req = (orte_scon_send_req_t*) cbdata;
    ...
    scon_native_convert_proc_name_scon_to_orte(&peer, &req->post.send.dst);
