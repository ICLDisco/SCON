...
#include "src/mca/sdl/base/static-components.h"


/*
 * Globals
 */
scon_sdl_base_module_t *scon_sdl = NULL;
scon_sdl_base_component_t *scon_sdl_base_selected_component = NULL;
...
int scon_sdl_base_open(scon_mca_base_open_flag_t flags)
{
    ...
    return scon_mca_base_framework_components_open(&scon_sdl_base_framework, flags);
}
...
/* VERY IMPORTANT: This framework is static, and is opened before any
   ...
   framework. */
SCON_MCA_BASE_FRAMEWORK_DECLARE(scon, sdl, "Dynamic loader framework",
                                NULL /* register */,
                                scon_sdl_base_open /* open */,
                                NULL /* close */,
                                mca_sdl_base_static_components,
                                SCON_MCA_BASE_FRAMEWORK_FLAG_NO_DSO);
