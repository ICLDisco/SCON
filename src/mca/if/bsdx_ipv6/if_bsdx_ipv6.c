 ...
 * Apple
 */
scon_if_base_component_t mca_if_bsdx_ipv6_component = {
       ...
       about the component itself */
    {
        ...
        .scon_mca_component_name = "bsd_ipv6",
...
static int if_bsdx_ipv6_open(void)
{
    ...
    for (cur_ifaddrs = *ifadd_list; NULL != cur_ifaddrs;
        ...
        if (0 < scon_output_get_verbosity(scon_if_base_framework.framework_output)) {
            char *addr_name = (char *) malloc(48*sizeof(char));
            inet_ntop(AF_INET6, &sin_addr->sin6_addr, addr_name, 48*sizeof(char));
            scon_output(0, "ipv6 capable interface %s discovered, address %s.\n",
