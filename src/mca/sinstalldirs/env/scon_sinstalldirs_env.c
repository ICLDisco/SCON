...
static int sinstalldirs_env_open(void);


scon_sinstalldirs_base_component_t mca_sinstalldirs_env_component = {
    /* First, the mca_component_t struct containing meta information
       about the component itself */
    {
        SCON_SINSTALLDIRS_BASE_VERSION_1_0_0,
    ...
    /* Next the scon_sinstall_dirs_t install_dirs_data information */
    {
        NULL,
    },
};
...
#define SET_FIELD(field, envname)                                         \
    do {                                                                  \
        char *tmp = getenv(envname);                                      \
         ...
         mca_sinstalldirs_env_component.install_dirs_data.field = tmp;     \
    } while (0)


static int
sinstalldirs_env_open(void)
{
